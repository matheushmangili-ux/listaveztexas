...
import { initDashboardCards, loadDemandReport, loadLostLeads, loadCanalFillRate } from '/js/dashboard-cards.js';

// Re-export pros consumidores existentes (dashboard-init.js importa daqui).
export { loadDemandReport, loadLostLeads, loadCanalFillRate };
